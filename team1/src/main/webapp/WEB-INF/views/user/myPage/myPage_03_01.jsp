...
<div class="container">
	...
	<div class="row">
		<div class="col-lg-3 text-center order_01-content-body">최종 주문 금액
		</div>
		<div class="col-lg-3 text-center order_01-content-body">사용 포인트</div>
		<div class="col-lg-3 text-center order_01-content-body">최종 결제 금액
		</div>
		<div class="col-lg-3  text-center order_01-content-body">적립 예상
			포인트</div>
	</div>

	<div class="row">
		<div class="col-lg-3 text-center order_01-content-item">[최종 금액
			합계]</div>
		<div class="col-lg-3 text-center order_01-content-item">-[사용
			포인트]</div>
		<div class="col-lg-3 text-center order_01-content-item">[최종 결제
			금액]</div>
		<div class="col-lg-3 text-center order_01-content-item">[적립 포인트]
		</div>
	</div>
			...
			<div class="col-lg-9 text-center order_01-content-body">
				<form>
					<input id="order_01-selectPay-card" type="radio" name="payment"
						value="card" onClick="selectPay(this.id)" checked disabled>
	...
	<div class="row">
		<div class="col-lg-4 text-center order_01-content-item">[회원 아이디]
		</div>
		<div class="col-lg-4 text-center order_01-content-item">[회원 이름]
		</div>
		<div class="col-lg-4 text-center order_01-content-item">[회원 연락처]
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="col-lg-10 join_02-main-right">
			<form>
				<input class="join_02-mobile admin_user_margin_left" disabled>
	...
	<div class="row">
		<div class="col-lg-6 offset-lg-3">
			...
			<div class="myPage_03_01-bottom-btn">
				<a class="myPage_03_01-myPage-btn login_05-btn"
					href="${contextPath}/login_01.do"> <img class="bottom_btn_size"
					src="${contextPath}/resources/img/common/return_page_btn.png"
					alt="비밀번호찾기 페이지_로그인페이지 이동 버튼 이미지">
				</a>
			</div>
		</div>
	</div>

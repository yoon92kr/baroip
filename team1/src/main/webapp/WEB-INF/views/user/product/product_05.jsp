...
<div class="container-fluid">
	...
	<div class="row">
		...
		<div class="col-lg-1 text-center">
			<a href="${contextPath}/product_06.do"><img
				class="product_05_write_btn"
				src="${contextPath}/resources/img/common/cs_write.png"
				alt="상품문의 글쓰기 버튼 이미지"></a>
		</div>
	...
	<c:choose>
		...
		<c:when test="${not empty PQAList}">
			<c:forEach var="i" begin="1" end="${PQAList.size()}">
				...
				<div class="row">
					...
					<div class="col-lg-1 text-left notice_01_section">
						<span>${PQAList[list].noticeList.user_id}</span>
					</div>
					<div class="col-lg-4 text-center notice_01_section">
						<a> <span class="">${PQAList[list].noticeList.notice_title}</span>
						</a>
					</div>
					<div class="col-lg-3 text-center notice_01_section">
						<span>${PQAList[list].noticeList.notice_cre_date}</span>
					</div>
				</div>
			</c:forEach>
		</c:when>

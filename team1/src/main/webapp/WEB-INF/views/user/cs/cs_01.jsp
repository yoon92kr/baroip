...
<c:set var="itemList" value="${QAList.size()}" />
...
<div class="container-fluid">
	...
	<!--  2022.01.07 윤상현   -->		
		<c:forEach var="i" begin="1" end="${itemList}">
			...
			<c:if test="${not empty QAList[j-1].notice_title && i< pageNoMax+1}">
				...
				<div class="row">
					...
					<div class="col-lg-7 text-center cs_01_listsection">
						<div class="faq-content">
							<button class="question" id="que-${j-1}">
								<span id="que-${j-1}-toggle" class="cs_01-que-tollge">∨</span> <span>${QAList[j-1].notice_title }</span>
							</button>
							<div class="answer" id="ans-${j-1}">${QAList[j-1].notice_body }</div>
						</div>
					</div>
				</div>
				</c:if>
